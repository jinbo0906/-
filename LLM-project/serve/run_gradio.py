...
class Model_center():
    ...
    def qa_chain_self_answer(self, question: str, chat_history: list = [], model: str = "chatglm_std", embedding="zhipuai",
...
with block as demo:
    with gr.Row(equal_height=True):
        with gr.Column(scale=15):
            gr.Markdown("""<h1><center>基于本地知识库的大模型助手</center></h1>
                <center>Jinbo Ma</center>
                """)
