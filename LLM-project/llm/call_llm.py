...
def get_completion_wenxin(prompt: str, model: str, temperature: float, api_key: str, secret_key: str):
    ...
    # 调用接口
    # ERNIE-Bot 4.0请求地址 https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/completions_pro
    # ERNIE-Bot请求地址 https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/completions
    # ERNIE-Bot-turbo请求地址 https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/eb-instant
    if model == "ERNIE-Bot 4.0":
